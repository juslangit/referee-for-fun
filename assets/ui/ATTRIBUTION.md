# Where the sport pictograms came from

The four locked sports on the selection screen use Olympic-style pictograms from
Wikimedia Commons. All four are in the **public domain**, so no credit is legally
required — it is here because everything else downloaded into this project carries
one, and a reader should not have to wonder which files are safe.

The badminton card is not here: it is `card_badminton.png`, a photograph of this
game rendered by `_card.gd`, and it is ours.
