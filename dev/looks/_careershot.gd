...
func _ready() -> void:
	...
	await _shot(arena, "res://dev/shots/_shot_career_start.png")
	...
	await _shot(arena, "res://dev/shots/_shot_career_up.png")
	...
	await _shot(arena, "res://dev/shots/_shot_career_result.png")
